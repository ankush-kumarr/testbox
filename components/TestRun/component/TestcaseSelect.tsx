      ...
      <div>
        ...
        <label
          ...
          <p className="ml-6 mt-2 text-sm font-normal">
            Select this option to include all test cases in this test run. If
            new test cases are added to the repository, they are also
            automatically included in this run.
          </p>
        </label>
      </div>
      <div>
        ...
        <label
          ...
          <p className="ml-6 mt-2 text-sm font-normal">
            You can alternatively select the sections to include in this test
            run. New test cases are not automatically added to this run in this
            case.
          </p>
        </label>
        {showSpecific && (
          <div className="ml-6 mt-3 text-sm px-3 py-1 flex flex-row justify-start space-x-4 bg-gray-200 rounded">
            <span>{totalTestcases} test cases included</span>
            <span
