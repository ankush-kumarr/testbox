  ...
  return (
    <>
      <button
        type="submit"
        {...propsNew}
        className={`inline-flex items-center px-2.5 py-1.5 shadow-sm text-xs font-medium rounded text-white bg-red hover:bg-gray-50 focus:outline-none   ${props?.className} my-submit-button`}
