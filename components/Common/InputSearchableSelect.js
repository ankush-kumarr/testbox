...
const InputSearchableSelect = ({ ...props }) => {
  ...
  return (
    <>
      <input
        className={`appearance-none block w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm pr-10 border-gray-300 cursor-default ${
      ...
      {showDropdown && (
        <div
          ...
          {filteredOptions.length === 0 ? (
            <div className="select-none py-1 px-3 h-auto">No matches</div>
          ) : (
